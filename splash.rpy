init python:
    menu_trans_time = 1
    splash_message_default = "No More Nightmares is not suitable for children,\nMonika haters,\nor those who are easily disturbed."
    splash_messages = [
    "This game is not suitable for children\nMonika haters,\nor those who are easily discombobulated.",
    "Monika thanks you for installing this mod.",
    "// TODO add scary splash message",
    "This is my first mod. I hope you like it.",
    "Why are you playing Act 2? I didn't change anything here...well, except these messages.",
    "Thank you for all the support, Jane <3",
    "At least it's not Giffany",
    "This is a placebo message that will make you feel scared.",
    "This message is a cognitohazard. Do not not attempt to find an error in this message.",
    "I wonder how many attempts does it take on average to see all 11 messages..."
    ]
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        menu:
            ...
            "I already completed the official game.":
                pass
        "Also, this mod is still not suitable for children or those who are easily disturbed."
        ...
        "(although it's too late at this point lol)"
        "By playing this modded version of Doki Doki Literature Club, you agree that you are still at least 13 years of age, and you consent to your continued exposure of highly disturbing content."
        menu:
            "I agree. Just let me play already.":
                pass
        "Initializing..."
    ...
    if persistent.playthrough == 2 and renpy.random.randint(0, 1) == 0:
